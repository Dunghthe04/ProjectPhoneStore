...
module.exports.index = async (req, res) => {
  if (res.locals.roleAccount.permissions.includes("product-view")) {
...
module.exports.changeStatusProduct = async (req, res) => {
  if (res.locals.roleAccount.permissions.includes("product-edit")) {
...
module.exports.delete = async (req, res) => {
  if (res.locals.roleAccount.permissions.includes("product-delete")) {
